...
"[project]/src/app/tickets/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
// Import React hooks: useState for state, useEffect for side effects (data fetching)
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/navigation.js [app-ssr] (ecmascript)");
"use client"; // Marks this as a Client Component for React hooks usage
;
;
;
;
function TicketsPage() {
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRouter"])(); // Hook for programmatic navigation
    // State to store list of tickets fetched from backend
    ...
    // Check muna natin kung naka-login si user pagkabukas ng page
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        // Hanapin natin 'yung user data sa storage
        const storedUser = localStorage.getItem("user");
        if (storedUser) {
            // Pag nahanap, i-save natin sa state para magamit
            setUser(JSON.parse(storedUser));
        } else {
            // Pag wala, redirect natin sa login page
            router.push("/login");
        }
    }, [
        router
    ]);
    // Kunin natin 'yung mga tickets galing sa backend
    const fetchTickets = async ()=>{
        try {
            // Tawagan natin 'yung tickets endpoint
            const res = await fetch("http://localhost:3001/api/tickets");
            if (res.ok) {
                // I-update na natin 'yung state gamit 'yung bagong data
    ...
    // Load natin 'yung tickets kapag okay na 'yung user login
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (user) {
            fetchTickets();
        }
    ...
    // Dito naman nag-uupdate ng status (pang Dept Head lang 'to)
    const handleStatusChange = async (ticketId, newStatus)=>{
        try {
            // Send natin 'yung bagong status sa server
            ...
            if (res.ok) {
                // Refresh natin 'yung listahan para updated 'yung itsura
                fetchTickets();
            } else {
    ...
    // Loading muna habang chinecheck pa natin 'yung login
    if (!user) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "flex justify-center items-center h-screen bg-gray-50 text-gray-500 font-medium",
            children: "Loading..."
        }, void 0, false, {
            fileName: "[project]/src/app/tickets/page.tsx",
            lineNumber: 91,
            columnNumber: 7
        }, this);
    }
    // Dito natin pinipili kung anong tickets lang ang dapat makita
    const filteredTickets = tickets.filter((ticket)=>{
        if (user.role === "Head") {
            // Pag Dept Head, dapat makita niya lahat ng requests sa department niya
            return ticket.dept === user.dept;
        }
        // Pag regular User, 'yung mga ginawa lang niya ang lalabas
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                className: "max-w-7xl mx-auto py-10 px-8 sm:px-12 lg:px-16",
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    user.role === "User" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                            ...
                                            children: filteredTickets.length > 0 ? // Map through filtered tickets and render rows
                                            filteredTickets.map((ticket)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                            ...
                                                            children: ticket.category || "General"
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/tickets/page.tsx",
                                                            lineNumber: 168,
                                                            columnNumber: 25
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                            ...
                                                            children: user.role === "Head" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                                value: ticket.status,
                                                                onChange: (e)=>handleStatusChange(ticket.id, e.target.value),
                                                                // Conditional styling based on status value
                                                                className: `px-2 py-1 text-xs font-semibold rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 ${ticket.status === "Open" ? "bg-green-100 text-green-800" : ticket.status === "Closed" ? "bg-red-100 text-red-800" : "bg-gray-100 text-gray-800"}`,
                                                                children: [
                                                                ...
                                                                lineNumber: 177,
                                                                columnNumber: 29
                                                            }, this) : // Read-only status badge for regular users
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                className: `px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${ticket.status === "Open" ? "bg-green-100 text-green-800" : ticket.status === "Closed" ? "bg-red-100 text-red-800" : "bg-gray-100 text-gray-800"}`,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__61e4029c._.js.map