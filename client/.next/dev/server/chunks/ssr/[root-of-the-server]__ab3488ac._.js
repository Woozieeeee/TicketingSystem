...
// We need this because we use interactive features like `useEffect` (for checking login) and `useState`.
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/navigation.js [app-ssr] (ecmascript)");
"use client"; // This directive tells Next.js that this component runs in the browser (client-side), not the server.
;
;
;
function Dashboard() {
    // 1. State: We store the user's information here once we retrieve it from Local Storage.
    // We initialize it to `null` because we don't know if a user is logged in yet.
    const [user, setUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    // 2. Router: Allows us to programmatically redirect the user (e.g., send them back to login if they aren't authenticated).
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRouter"])();
    // 3. Effect: This runs *after* the component mounts (loads in the browser).
    // It checks if the user is actually logged in.
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        // Retrieve the user data string we saved during login.
        const storedUser = localStorage.getItem("user");
        // If no user data is found, they shouldn't be here! Redirect to login.
        if (!storedUser) {
            router.push("/login");
            return;
        }
        try {
            // Parse the JSON string back into a JavaScript object and save it to state.
            setUser(JSON.parse(storedUser));
        } catch (e) {
            // If the data is corrupted (not valid JSON), clear it and redirect to login for safety.
        ...
        router
    ]); // The dependency array `[router]` ensures this effect respects the router instance.
    // 4. Loading State: While we are checking Local Storage, `user` is null.
    // We show a simple loading message to prevent the "protected" content from flashing briefly.
    if (!user) {
    ...
    // 5. Render: If we have a user, we display their dashboard.
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        style: {
            maxWidth: "600px",
            margin: "40px auto",
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                onClick: ()=>{
                    // Logout Logic:
                    // 1. Clear the "proof" of login from the browser's storage.
                    localStorage.removeItem("user");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ab3488ac._.js.map