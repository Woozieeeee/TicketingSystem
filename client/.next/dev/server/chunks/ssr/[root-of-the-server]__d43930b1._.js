...
function getRelativeTime(dateString) {
    ...
    const diffInSeconds = Math.abs(Math.floor((now.getTime() - updated.getTime()) / 1000));
...
function RoleBasedDashboard() {
    ...
    const loadTickets = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        ...
        try {
            ...
            if (res.ok) {
                ...
                setTickets(filtered);
                console.log("DEBUG - Latest Ticket Date:", filtered[0]?.lastUpdated || filtered[0]?.date);
    ...
    const displayDate = latestTicket ? latestTicket.lastUpdated || latestTicket.date : new Date().toISOString();
    if (!user) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d43930b1._.js.map