              ...
              return (
                ...
                >
                  ...
                  <div className={`flex flex-col ${isMe ? "items-end" : "items-start"} max-w-[80%] md:max-w-md`}>
                    ...
                    {isDeleted ? (
                      <div
                        className={`p-2.5 px-4 rounded-2xl shadow-sm text-[11px] italic flex items-center gap-1.5 ${isMe ? "bg-slate-100 text-slate-600 border border-slate-200 rounded-tr-none" : "bg-slate-100 text-slate-600 border border-slate-200 rounded-tl-none"}`}
                      >
