...
const userRoutes = require("./routes/user"); // 🟢 1. IDINAGDAG: I-require ang bagong routes file mo
...
app.use("/api/users", userRoutes); // 🟢 2. IDINAGDAG: I-register ang endpoint prefix para sa users
